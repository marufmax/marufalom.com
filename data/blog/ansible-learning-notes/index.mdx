...
Ansible হচ্ছে একটি ওপেন সোর্স টুল যা দিয়ে IT অপারেশনের অনেক রিপেটেটিভ কাজকে অটোমেট করা যায়। ধরুন আপনি একজন ডেভঅপস হিসেবে কাজ করছেন। এখন মাঝে মাঝেই আপনার নতুন নতুন কিছু সার্ভার তৈরি করতে হয়। এখন প্রতিবারই সেইম Nginx ইন্সটল করা, docker ইন্সটল করা, ইউজার তৈরি করা। এগুলো খুবই রিপেটেটিভ হয়ে যায়। এক্ষেত্রে আপনি Ansible ইউজ করতে পারেন।
অথবা আপনার কোম্পানিতে নতুন ডেভলপার অনবোর্ড হলে তার জন্য কিছু সেট অফ টুলস ইন্সটল করে দিতে হয়। এক্ষেত্রে আপনি একটা প্লেবুক বানিয়ে রাখলে ডেভলপার নিজেই প্লেবুক রান করে নিজে নিজে সব সেটকরে নিতে পারবে। আপনার জন্য হ্যাসেল কমে গেল।
ইত্যাদি এরকম বিভিন্ন কাজকে অটোমেট করার জন্যই Ansible ব্যাবহৃত হয়ে থাকে।

এখানে আমি মুলত টিউটোরিয়াল লিখিনি। আমি যখন Ansible শিখতে গিয়ে যেসকল জিনিস নোট করা প্রয়োজন মনে হয়েছে সেগুলোই লিখেছি। হয়তো আপনারও কাজে লাগতে পারে।

## Learning metarials

- [Learn Linux TV](https://www.youtube.com/playlist?list=PLT98CRl2KxKEUHie1m24-wkyHpEsa4Y70)

- [Techworld Nana](https://www.youtube.com/watch?v=Wr8zAU-0uR4)

- [KodeKloud](https://kodekloud.com/topic/playbook-run-options) <small>\*Paid</small>
...
এক রকম ভেরিএবল যা `hostvars` নামেও পরিচিত। এটি অনেকেটা পিএইচপি এর \_\_SERVase
...
সবগুলোই মোটামুটি সেলফ এক্সপ্লেনেটরি তাই আর এক্সপ্লেইন করলাম না। এগুলো ইউজ করতে চাইলে অবশ্যই দুই পাশে কার্লি ব্রাকেট দিয়ে ইউজ করতে হবে। যেমনঃ `{{ ansible_port }}` এর সাথেও তুলনা করা যায়। উদাহরণঃ `hostvars[webserver].dns_server`, এখানে webserver হোস্টের dns এ্যাড্রেস ইউজ করা হচ্ছে অন্য ম্যাজিক ভেরিয়াবলের মাধ্যমে।

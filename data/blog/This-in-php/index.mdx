...
canonicalUrl: "/this-in-php-programming-language"
...
summary: $this is a special variable, Its reffers to current object. To access a private or protected property we need this keyword for accessing them. So, `$this ->` means current object.
